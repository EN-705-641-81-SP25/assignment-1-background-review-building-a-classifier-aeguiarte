...
def single_run(dev_d: Dict[str, List[Union[str, int]]],
    ...
    train_config = EasyDict({
        ...
        'num_epochs': 40,  # the total number of times all the training data is iterated over
    ...
    visualize_epochs(epoch_train_losses, epoch_dev_loss, "single_run_loss.png", train_config.embeddings)

def explore_embeddings(dev_d: Dict[str, List[Union[str, int]]],
                       train_d: Dict[str, List[Union[str, int]]],
                       test_d: Dict[str, List[Union[str, int]]]):
    # TODO: once you have completed the model.py, you can run this function to initialize and train your model with
    # TODO: different embeddings, and visualize the performance across different embeddings with two plots
    ...
    for embedding_type in EMBEDDING_TYPES:
        ...
        print(f"Training Sentiment Classifier model using embeddings: {embedding_type}...")
...
if __name__ == '__main__':
    ...
    # uncomment the following line to run
    print(f"Exploring performance for the following embeddings: {EMBEDDING_TYPES}...")
